...
public class BaseResult{
    ...
    private List datas; //TODO 以后这玩意设置成Object类

    private Cursor cursor;

    private String success;

    private List<Errors> errors; //TODO 以后这玩意设置成Object类
    ...
    public static BaseResult FALIED( Object object){
        List<Object> list = new LinkedList<>();
        list.add(object);
        return new BaseResult(Result.not_ok, list, "操作失败");
    }

    public BaseResult(List<Errors> errors,String success){
        this.errors=errors;
        this.success=success;
    }

    public static BaseResult FAILED(List<Errors> errors, String success) {
        return new BaseResult(errors, "操作失败");
    }

    public BaseResult(String success){
        this.success=success;
    }
