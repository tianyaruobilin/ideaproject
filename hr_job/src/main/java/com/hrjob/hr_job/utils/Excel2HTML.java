...
public class Excel2HTML {
     ...
     */
    public static String readExcelToHtml(InputStream inputStream,String htmlPositon, boolean isWithStyle){
    ...
    private static void dealExcelStyle(Workbook wb,Sheet sheet,Cell cell,StringBuffer sb){
        ...
        if (cellStyle != null) {
            HorizontalAlignment alignment = cellStyle.getAlignment();//获取对其方式
            //    sb.append("align='" + convertAlignToHtml(alignment) + "' ");//单元格内容的水平对齐方式
            VerticalAlignment verticalAlignment = cellStyle.getVerticalAlignment();
            sb.append("valign='"+ convertVerticalAlignToHtml(VerticalAlignment.forInt(verticalAlignment.getCode()))+ "' ");//单元格中内容的垂直排列方式

            if (wb instanceof XSSFWorkbook) {

                XSSFFont xf = ((XSSFCellStyle) cellStyle).getFont();
                short boldWeight = xf.getFontHeight();
                String  align = convertAlignToHtml(HorizontalAlignment.forInt(alignment.getCode()));
                sb.append("style='");
